...
C     EXTERNAL
C
      REAL*8 R2,DOT,ET,RAP,DJ,SumDot,SumDotTEST,pt,ALPHAS,PtDot
      logical cut_bw,setclscales,dummy_cuts
      external R2,DOT,ET,RAP,DJ,SumDot,SumDotTEST,pt,ALPHAS,cut_bw,setclscales,PtDot
      external dummy_cuts
C
C     GLOBAL
C
...
c     MY CUTS
c      
      REAL*8 minmee2, maxmee2, mee1, mee2
      REAL*8 ptot(0:3)
      logical mee1pass, mee2pass
